...
import { Clock, CollectionTag, Connection, Cpu, DataAnalysis, MessageBox, Setting, Tools, UserFilled } from '@element-plus/icons-vue'
...
const menuItems = [
  ...
  { path: '/admin/agent-logs', label: 'Agent 日志', icon: Clock }
]
